...
public class NPC : MonoBehaviour, IGoap, ICollector, IDestroyable
{
	...
	public AgentDeath OnAgentDeath = new AgentDeath();
	...
	public class AgentDeath : UnityEvent<GameObject>
	{
